    ...
    <footer className="font-Tajawal bg-primary w-full text-white" dir='rtl'>
      <div className="mx-auto flex flex-wrap justify-between p-8">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 mb-4">
          ...
          <ul>
            <li><a href={`tel:${INFO.phone}`} className="block hover:text-gray-300" dir='ltr'>{INFO.phone}</a></li>
            <li><a href={`mailto:${INFO.email}`} className="block hover:text-gray-300" dir='ltr'>{INFO.email}</a></li>
          </ul>
        </div>
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 mb-4">
          ...
          <ul>
            <li className="flex align-items">
              ...
              <a href={INFO.facebook} className="block hover:text-gray-300 mr-2" target='blank'>Facebook</a>
            ...
            <li className="flex align-items">
              ...
              <a href={`tel:${INFO.phone}`} className="block hover:text-gray-300 mr-2" target='blank'>Whatsapp</a>
            </li>
            <li className="flex align-items">
              ...
              <a href={INFO.instagram} className="block hover:text-gray-300 mr-2" target='blank'>Instagram</a>
            </li>
          </ul>
        </div>
      </div>
