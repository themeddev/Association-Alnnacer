        ...
        >
            ...
            <div className='z-10 w-full flex items-center flex-col gap-8 tracking-wider'>
                ...
                <div className='font-bold w-full flex flex-col sm:flex-row justify-center items-center gap-6'>
                    <div className='bg-white p-4 w-full sm:w-1/2 text-center rounded-sm '>RIB : 2342 2345 6742</div>
                    <div className='bg-white p-4 w-full sm:w-1/2 text-center rounded-sm'>الحضور الى مقر الجمعية</div>
                </div>
